        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center"><img src="<?php echo $product['image']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;" /></td>
              <td class="text-left"><?php echo '<a href="' . $product['url_product'] . '">' . $product['name'] . '</a>' ; ?>
              ...
              <td class="text-right" nowrap="nowrap"><?php echo $product['total']; ?></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
