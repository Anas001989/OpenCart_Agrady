      ...
      <div class="panel-body">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
           ...
           <td class="text-left">
           <?php if ($ipd == 1) { ?>
           <?php if (($ipd == 1) && ($ipdsaleorder)) { ?>  
           <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['image'];?>" /></a>
           <?php } ?>
           <a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
           <?php if (($ipd == 1) && ($ipdbtnorder)) { ?> 
           - <a href="<?php echo HTTP_CATALOG.'index.php?route=product/product&product_id='.$product['product_id'];  ?>" target="_blank" class="btn btn-primary"><?php echo $text_view_lrppo; ?></a>  
           <?php } ?>
           <?php } else { ?>
           <a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
           <?php } ?>       
