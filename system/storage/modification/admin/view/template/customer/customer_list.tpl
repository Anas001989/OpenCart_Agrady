...
<?php if ($adveci_clist_orders_status == '1') { ?>
              <td class="text-left"><?php if ($sort == 'total_orders') { ?>
                ...
                <?php } ?></td>
<?php } ?>
<?php if ($adveci_clist_total_value_status == '1') { ?>
              <td class="text-left"><?php if ($sort == 'total_value') { ?>
...
<?php } ?> 								
              ...
              <td class="text-left"><a href="<?php echo $customer['edit']; ?>"><?php echo $customer['name']; ?></a></td>
...
<?php if ($access_permission2 && $laccess) { ?>		
<?php if ($adveci_clist_orders_status == '1') { ?>	
              <td class="text-left"><?php echo $customer['total_orders']; ?></td>
<?php } ?>
<?php if ($adveci_clist_total_value_status == '1') { ?>	  
              <td class="text-left"><?php echo $customer['total_value']; ?></td>  
<?php } ?>
<?php } ?>
