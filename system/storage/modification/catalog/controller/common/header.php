...
class ControllerCommonHeader extends Controller {
	...
	if ($this->customer->isLogged() && $this->config->get('adveci_customer_track')) {
	...
	$query = $this->db->query("INSERT INTO " . DB_PREFIX . "customer_track (route, ip_address, customer_id, current_url, referrer, agent_type, access_time) VALUES ('" . $route . "', '" . htmlentities($ip_address) . "', '" . (int)$this->customer->getId() . "', '" . htmlentities($current_url) . "', '" . htmlentities($referrer) . "', '" . htmlentities($agent_type) . "', '" . date("Y/m/d H:i:s") . "')");
...
$data['go_to_cart_button'] = $this->load->controller("common/go_to_cart/getCartButton");// GO TO CART end
