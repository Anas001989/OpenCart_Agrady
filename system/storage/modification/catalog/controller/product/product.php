...
// GO TO CART start
            ...
            $data['go_to_cart'] = $this->url->link('checkout/cart');
            $data['text_go_to_cart']=$this->language->get('text_go_to_cart');
            $data['go_to_cart_status'] = $this->config->get('go_to_cart_status');
            $data['cart_product_id'] = $this->load->controller("common/go_to_cart",$product_id);
            // GO TO CART end
