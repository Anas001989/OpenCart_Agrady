        ...
        <div class="right">
          ...
          <?php if ($options) { ?>
            ...
            <div class="option form-group<?php echo ($option['required'] ? ' required' : ''); ?> option-<?php echo $option['type']; ?>">
              ...
              <select name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" product_option_id="<?php echo $option['product_option_id']; ?>" class="form-control product_option_go_to_cart">
            ...
            <div class="form-group cart <?php echo isset($labels) && is_array($labels) && isset($labels['outofstock']) ? 'outofstock' : ''; ?>">
              ...
              <script>
                ...
                $input.keydown(function (e) {
                 ...
                 <?php if($go_to_cart_status==1 && $cart_product_id==1 && empty($options)) { ?>
                 <a href="<?php echo $go_to_cart; ?>" data-toggle="tooltip" title="<?php echo $text_go_to_cart; ?>" class="button cart-custom-button product_go_to_cart<?php echo $product_id; ?>"><i class="fa fa-shopping-cart"></i> <?php echo $text_go_to_cart; ?></a>           
              <?php  } else { ?>
                  <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="button product_go_to_cart<?php echo $product_id; ?>"><span class="button-cart-text"><?php echo $button_cart; ?></span></button>
              <?php } ?>
				...
				<?php //} ?>	
                  ...
                  <div class="button-group">
                    ...
                    <div class="cart <?php echo isset($product['labels']) && is_array($product['labels']) && isset($product['labels']['outofstock']) ? 'outofstock' : ''; ?>">
                      <?php if($go_to_cart_status==1 && $product['cart_product_id']==1 && empty($product['options'])) { ?>
        <button class="button hint--top cart-custom-button go_to_cart<?php echo $product['product_id']; ?>" type="button" onclick="carttoadd.checkoutredirect('<?php echo $product['product_id']; ?>');" data-hint="<?php echo $text_go_to_cart; ?>"><i ></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_go_to_cart; ?></span></button>
        <?php } else { ?>
        <a onclick="carttoadd.addtocart('<?php echo $product['product_id']; ?>', $(this).parents('.product-details').find('.input-number').val() );" class="button hint--top go_to_cart<?php echo $product['product_id']; ?>" data-hint="<?php echo $button_cart; ?>"><i class="button-left-icon"></i><span class="button-cart-text"><?php echo $button_cart; ?></span><i class="button-right-icon"></i></a>
        <?php } ?>
