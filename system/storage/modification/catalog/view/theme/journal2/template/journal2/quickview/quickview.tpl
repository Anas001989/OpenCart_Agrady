...
<div id="container">
    ...
    <div class="form-group cart <?php echo isset($labels) && is_array($labels) && isset($labels['outofstock']) ? 'outofstock' : ''; ?>">
      ...
      <input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
         ...
         <?php if($go_to_cart_status==1 && $cart_product_id==1) { ?>
                 <a href="<?php echo $go_to_cart; ?>" target="_top" data-toggle="tooltip" title="<?php echo $text_go_to_cart; ?>" class="button cart-custom-button product_go_to_cart"><i class="fa fa-shopping-cart"></i> <?php echo $text_go_to_cart; ?></a>           
              <?php } else { ?>
                  <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="button product_go_to_cart"><span class="button-cart-text"><?php echo $button_cart; ?></span></button>
              <?php } ?>
