...
// GO TO CART start
            ...
            $this->data['go_to_cart'] = $this->url->link('checkout/cart');
            $this->data['text_go_to_cart']=$this->language->get('text_go_to_cart');
            $this->data['go_to_cart_status'] = $this->config->get('go_to_cart_status');
            // GO TO CART end
...
$cart_product_id = $this->load->controller("common/go_to_cart",$product['product_id']);
