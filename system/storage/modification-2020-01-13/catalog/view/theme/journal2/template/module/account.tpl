<div class="box">
  <div class="box-content list-group">
      <ul>
        ...
        <li><a href="<?php echo $order; ?>" class="list-group-item"><?php echo $text_order; ?></a><?php if ($adveci_purchased_status == '1') { ?> <a href="<?php echo $purchased; ?>" class="list-group-item"><?php echo $text_purchased; ?></a> <?php } ?></li>
