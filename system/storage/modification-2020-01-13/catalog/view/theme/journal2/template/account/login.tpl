  ...
  <div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div class="row login-content">
        ...
        <?php if (!empty($autologin_status) && !empty($autologin_show_checkbox)) { ?>
        <div class="form-group">
          <input type="hidden" name="autologin_has_checkbox" value="1">
          <label>
            <input type="checkbox" name="autologin_remember_me" <?php echo $autologin_checked; ?>>
            <span style="color: <?php echo $autologin_label_color; ?>"><?php echo $autologin_label_text; ?></span>
          </label>
        </div>
        <?php } ?>
