...
<!-- <a href="window.history.back();"  class=" backb" type="button" ></a> -->
<!-- <a href="<?php echo $_SERVER['HTTP_REFERER'] ?>" type="button" class="backb"></a> -->
    ...
    <li class="mini-cart-info">
      <table class="table table-striped">
        ...
        <tr>
          ...
          <?php if($go_to_cart_status==1) { ?>
              <td class="text-center remove"><button type="button" onclick="carttoadd.remove('<?php echo $product[version_compare(VERSION, '2.1', '<') ? 'key' : 'cart_id']; ?>');document.location.reload(true); " title="<?php echo $button_remove; ?>" class=""><i class=""></i></button></td>
          <?php } else { ?>
...
<a id="cartg0" href="https://agrady.com/index.php?route=checkout/checkout"></a>
<button onclick="goBack()" class=" backb"></button>
