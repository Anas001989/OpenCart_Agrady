...
$this->load->model('catalog/product');
	...
	public function info() {
		...
		if ($order_info) {
            ...
            //updating order ssl issue when view order
            ...
            $product_info = $this->model_sale_order->getProductImage($product['product_id']);
            if ($product_info['image'] && file_exists(DIR_IMAGE . $product_info['image'])) {                
            $productImage = $this->model_tool_image->resize($product_info['image'], 80, 80);
            } else {                
            $productImage = $this->model_tool_image->resize('no_image.jpg', 80, 80);
            }
...
'image' => $productImage,
            ...
            $data['text_view_lrppo'] = $this->language->get('text_view_lrppo');
	...
	public function invoice() {
		...
		foreach ($orders as $order_id) {
            ...
            $this->load->model('tool/image');
             ...
             'image'    => $this->model_tool_image->resize($product['img']['image'],60, 60),
