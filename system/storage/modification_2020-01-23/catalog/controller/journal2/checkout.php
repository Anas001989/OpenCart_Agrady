...
class ControllerJournal2Checkout extends Controller {
    ...
    public function index() {
        ...
        // Autologin
        $this->data['autologin_status']        = $this->config->get('module_autologin_status');
        $this->data['autologin_show_checkbox'] = $this->config->get('module_autologin_show_checkbox');

        if ($this->config->get('module_autologin_checked_by_default')) {
            $this->data['autologin_checked'] = 'checked';
        } else {
            $this->data['autologin_checked'] = '';
        }

        if ($this->config->get('module_autologin_label_color')) {
            $this->data['autologin_label_color'] = $this->config->get('module_autologin_label_color');
        } else {
            $this->data['autologin_label_color'] = 'inherit';
        }
        ...
        if (!empty($autologin_label_text[$language_code])) {
            $this->data['autologin_label_text'] = $autologin_label_text[$language_code];
        } else {
            $this->data['autologin_label_text'] = 'Remember me';
        }
        // Autologin END
