					...
					<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
						<div class="col-sm-9">
							<div class="form-group">
								...
								<div class="col-sm-10">
								  <textarea name="invoice_manager_header<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset(${'invoice_manager_header' . $language['language_id']}) ? ${'invoice_manager_header' . $language['language_id']} : ''; ?></textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-invoice-footer"><?php echo $entry_invoice_footer; ?></label>
								<div class="col-sm-10">
								  <textarea name="invoice_manager_footer<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset(${'invoice_manager_footer' . $language['language_id']}) ? ${'invoice_manager_footer' . $language['language_id']} : ''; ?></textarea>
								</div>
							</div>
						</div>
					...
					<div class="tab-pane" id="languagemail<?php echo $language['language_id']; ?>">
						<div class="col-sm-9">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
								  <textarea name="invoice_manager_message<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset(${'invoice_manager_message' . $language['language_id']}) ? ${'invoice_manager_message' . $language['language_id']} : ''; ?></textarea>
								</div>
							</div>
						</div>
						<div style="padding:0px;" class="col-sm-3">
